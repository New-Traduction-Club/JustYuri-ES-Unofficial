...
label HDY_wallpaper:
    ...
    $show_hdy("hdy_derpy_smile")
    #Have her tell you where it is once this is coded in
    ...
    #Coding magic so the cursor is forcefully pulled towards "yes".
...
label HDY_mcspaghetti:
    ...
    #Open link to Mcspaghetti
    #https://static.wikia.nocookie.net/ronaldmcdonald/images/5/51/Mcspaghetti-pr4.jpg/revision/latest/scale-to-width-down/340?cb=20181118181925
...
label HDY_amongus:
    ...
    menu: 
        "Amogus":
            pass
    # I don't know if renpy can handle ඞ, but it works in discord and is unicode.
...
label HDY_rickroll:
    ...
    # Rick assly Music at https://www.youtube.com/watch?v=dQw4w9WgXcQ
    #may not auto play due to firefox security settings but good enough
    $show_hdy("hdy_rickroll")
    # she will dance untill you click
    hdy "..."
    $show_hdy("hdy_derpy_smile")
    hdy "..."
    hdy "{i}banana{/i}"
...
label HDY_asadstory:
    ...
    # (If you want to use the actual song or if you even can, here it is https://www.youtube.com/watch?v=EfZxZmbbWI8
    # Meme video for reference https://www.youtube.com/watch?v=DcrrUuRoWT4)
    return
...
label HDY_scatman:
    ...
    # Disappointed face, crossed arms.
...
label hbomb_minigame:
    $show_hdy("hdy_bomb_show")
    #pulls out an h bomb, tosses it to the player
    hdy "Weeeeeeeeeeee!!!!"
...
label hbomb_exploded:
    #nuke explosion animation and noise
...
label HDY_WaspInTheRoom: 
    ...
    #hdy "[PLAYER] THE ARTIST FORGOT TO RENDER MY ARMS I CAN’T THROW THE H BOMBS!" 
    hdy "[PLAYER] I CAN'T FIND THE H BOMBS!"
    return

label HDY_AUSTRALIA:
    #$show_hdy("hdy_AUSTRALIA")
...
label HDY_kiss:
    #whole kiss code extracted from the kiss code in a13
    $yuri_y_zoom = 0.15
    $yuri_y_linear = 0
