init python:
    ...
    full_wordlist = []
    try:  # Error Handling is very important!
        with codecs.open('/poemwords_different.txt', 'r', 'utf-8') as wordfile:  # Explicitly declare encoding.  Fix #1
    ...
    except Exception as e: #General Error Catch for File Errors
