...
class Orientation(Enum):
    ...
    def delta(orientation, delta):
        ...
        if orientation is Orientation.none:
            ...
            if orientation + delta < 0:
                temp = (orientation + 360 + delta) % 360
                if temp == 0:
                    return Orientation.up
                elif temp == 270:
...
class PieceType(Enum):
    ...
    def can_rotate(piece, target_orientation):
        ...
        if abs(piece.orientation - target_orientation) == 180:  # 270 or 90 are the allowed values
            return False
...
class LaserPathNode(object):
    ...
    def __str__(self):
        return "( " + str(self.type) + ", " + str(self.position) + ", " + str(self.direction) + ")"
...
class Move(object):
    ...
    def __str__(self):
        return "{ T: " + str(self.type) + ", P: " + str(self.position) + ", V: " + str(self) + "}"
...
class Piece(object):
    ...
    def __str__(self):
        return "(" + str(self.color) + "," + str(self.type) + "," + str(self.orientation) + ")"
