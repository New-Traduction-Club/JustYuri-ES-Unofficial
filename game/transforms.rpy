...
define wipeleft = ImageDissolve("images/gui/menu/wipeleft.png", 0.5, ramplen=64)


define wipeleft_scene = MultipleTransition([
    False, ImageDissolve("images/gui/menu/wipeleft.png", 0.5, ramplen=64),
    Solid("#000"), Pause(0.25),
    Solid("#000"), ImageDissolve("images/gui/menu/wipeleft.png", 0.5, ramplen=64),
    True])
...
image noise:
    truecenter
    "images/vfx/noise1.png"
    pause 0.1
    "images/vfx/noise2.png"
    pause 0.1
    "images/vfx/noise3.png"
    pause 0.1
    "images/vfx/noise4.png"
    pause 0.1
    xzoom -1
    "images/vfx/noise1.png"
    pause 0.1
...
define eye_shut = ImageDissolve("vfx/eye.png", 1.0, 64, ramptype="mcube", reverse=True)

define eye_open_slow = ImageDissolve("vfx/eye.png", 4.0, 64, ramptype="cube")
define eye_shut_slow = ImageDissolve("vfx/eye.png", 4.0, 64, ramptype="mcube", reverse=True)